...
- box-sizeing: inherit 表示从父元素继承 box-sizing 属性的值
...
**层叠上下文**（stacking context）是用于描述元素在垂直方向上的层叠顺序。当元素在不同的层叠上下文时，它们的显示顺序会受到影响。**每个层叠上下文都是一个独立的渲染层，它可以包含其他元素，并具有自己的层叠顺序**。层叠上下文的创建和属性设置会影响元素的层叠顺序和显示效果。

**层叠顺序**（stacking order）表示元素发生层叠时有着特定的垂直显示顺序。下面是盒模型的层叠规则：
...
![image](https://github.com/XieZongChen/review-notes/assets/46394163/9fe255f6-0a80-42ee-bfe4-e47b967e75b1)
